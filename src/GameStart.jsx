          ...
          <div>
            ...
            <ul className="mt-5 space-y-2">
              <li className="">
                ...
                >
                  Зарабатывай 10 баллов{" "}
                </span>{" "}
                за каждый правильно собранный товар;
              </li>
              <li>
                <span
                  style={{
                ...
                >
                  Пройди все 10 уровней сложности{" "}
                </span>{" "}
                – чем выше уровень, тем больше товаров и заказов, но меньше
                времени;
              </li>
              <li>
                <span
                ...
                – на одном уровне можно совершить максимум 2 ошибки при сборке
                заказов.
              </li>
            </ul>
            <div
